...
import { VBtn, VCard, VCardItem, VCardText, VCardTitle } from 'vuetify/components'
import VueApexCharts from 'vue3-apexcharts'
import MoreBtn from '@/components/UpgradeToPro.vue'
  ...
  <VCard>
    ...
    <VCardText>
      ...
      <div class="d-flex align-center mb-5 gap-x-4">
        ...
        <p class="mb-0">
          Your sales performance is 45% <span class="text-high-emphasis">😎</span> better compared
          to last month
        </p>
      </div>
